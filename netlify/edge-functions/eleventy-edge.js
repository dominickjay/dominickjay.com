...
export default async (request, context) => {
  try {
    ...
    console.log(tvData[0].seasons[Object.keys(tvData[0].seasons).pop()].episode[tvData[0].seasons[Object.keys(tvData[0].seasons).pop()].episodes[Object.keys(tvData[0].seasons).pop()]]);
