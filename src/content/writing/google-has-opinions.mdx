...
<FYIBlock type="info">
	...
	<div slot="body">Sounds pretty messy, right? Even if the vagueness wasn't intended, having Google fill in the gap to attempt to explain what it thinks is right, is a pretty bad idea and leaves way to an interpretation that is wildly inaccurate. Bricks and unicorns. Maybe AIsplaining is the right term.</div>
</FYIBlock>
