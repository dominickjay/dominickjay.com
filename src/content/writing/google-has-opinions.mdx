...
description: >-
  Google's search results are summarising your page. Its opinions aren't always
  right - they just need to look like yours.
pubDate: '2026-08-03'
growth: seedling
tags:
  - seo
  - ai
atprotoDocumentRkey: 3msalsxlbccbw
---
...
That's quite the hit to click-throughs, because searchers use that valuable description to decide whether or not they want to click through to the page.
