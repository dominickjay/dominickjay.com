...
import ReadingOrderDemo from '../../components/demos/ReadingOrderDemo.astro';
...
<article class="reading-order-card">
    ...
    <img src="https://placehold.co/600x400" alt="Card image" />
</article>
...
<style>{`
    ...
    .reading-order-example .reading-order-card--1 {
        order: 3;
    }

    .reading-order-example .reading-order-card--2 {
        order: 1;
    }

    .reading-order-example .reading-order-card--3 {
        order: 2;
    }
...
<div class="reading-order-example">
    ...
    <a href="#" class="item item--3" tabindex="0" aria-label="Read more about this article">
        <img src="https://placehold.co/600x800" alt="Card image" />
    </a>
</div>

## Example 3: Our grid layout
...
<div class="reading-order-example reading-order-example-2">
    ...
    <a href="#" class="item item--6" tabindex="0" aria-label="Read more about this article">
        <img src="https://placehold.co/600x800" alt="Card image" />
    </a>
</div>
...
Sometimes visual design and accessibility can butt heads, and have done for *years*. Now, with the introduction of `reading-flow` and `reading-order`, this conflict can be reduced significantly. Now, as developers, we don't need to choose between a beautiful design and an accessible one, we can have both. We're finally getting the right tools to be able to do this, without the need for complex JavaScript solutions or manual tabindex management. This is a win for everyone.

That being said, this is **still** a work in progress, and support is still sparse - more sparse than it should be given the importance of the feature. To help this along, developers need to be able to advocate for the feature and help push it forward by testing it and reporting any issues they find, leading to the next generation of web layouts being both beautiful and universally accessible.
