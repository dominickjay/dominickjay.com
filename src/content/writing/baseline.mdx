...
<ul class="checklist">
  ...
  <ChecklistItem id="link-mdn-badge">If you're writing about a feature specifically because of its support status, say which tier and since when rather than just linking to the MDN badge.</ChecklistItem>
</ul>
