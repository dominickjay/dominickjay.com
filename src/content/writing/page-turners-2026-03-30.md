...
<li>
      <a class="link-item stacked" href=https://nerdy.dev/css-logical-rhythm target="_blank" rel="noopener">
        ...
        <div class="body stacked">
          <span class="title h3">Can you feel the rhythm‽ · March 13, 2024</span>
          <p>It&#39;s much more than vertical rhythm on the web</p>
          <img src=https://nerdy.dev//media/logical-rhythm.png alt="" loading="lazy">
        </div>
      </a>
    </li>
<li>
      <a class="link-item stacked" href=https://youtube.com/shorts/ir_SB_vqaQY?si=pfK12kHiLfCLQ_PE target="_blank" rel="noopener">
        <div class="meta">
          ...
          <span class="type eyebrow">videos</span>
        </div>
        <div class="body stacked">
...
<li>
      <a class="link-item stacked" href=https://www.stubbornella.org/2011/10/08/scope-donuts/ target="_blank" rel="noopener">
        <div class="meta">
          <span class="domain">www.stubbornella.org</span>
          <span class="type eyebrow">link</span>
        </div>
        <div class="body stacked">
