...
description: >-
  Reaching an element's siblings in CSS used to be tough. :has() changes
  everything.
intro: >-
  I was experimenting with the :has() function recently, and put together a
  quick demonstration of how to select all an elements siblings and style them.
  It ended up being picked by CodePen, so this post is demonstrating how that
  was put together.
pubDate: '2023-04-26'
tags:
  - css
...
growth: evergreen
atprotoDocumentRkey: 3mopuito2wspq
---
